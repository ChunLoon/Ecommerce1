...
class ProductProvider with ChangeNotifier {
  ...
  Future<void> getUserData() async {
    ...
    QuerySnapshot userSnapShot =
        await FirebaseFirestore.instance.collection(FirebaseAuth.instance.currentUser.uid).get();
    userSnapShot.docs.forEach((element) {
       // if (currentUser.uid == element.data()["UserId"]) {
          userModel = UserModel.fromDocument(element);
...
//view more feature
  Future<void> getFeatureData() async {
    ...
    featureSnapShot.docs.forEach(
      (element) {
        featureData = Product.fromDocument(element);
...
//view more newachives
  ...
  Future<void> getNewAchiveData() async {
    ...
    achivesSnapShot.docs.forEach(
      (element) {
        newAchivesData = Product.fromDocument(element);
