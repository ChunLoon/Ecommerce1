...
class CategoryProvider with ChangeNotifier {
  ...
  Future<void> getDressIconData() async {
    ...
    dressSnapShot.docs.forEach((element) {
        dressiconData = CategoryIcon.fromDocument(element);
  ...
  Future<void> getShirtIcon() async {
    ...
    shirtSnapShot.docs.forEach(
      (element) {
        shirticonData = CategoryIcon.fromDocument(element);
  ...
  Future<void> getshoesIconData() async {
    ...
    shoesSnapShot.docs.forEach(
      (element) {
        shoesiconData = CategoryIcon.fromDocument(element);
  ...
  Future<void> getPantIconData() async {
    ...
    pantSnapShot.docs.forEach(
      (element) {
        panticonData = CategoryIcon.fromDocument(element);
  ...
  Future<void> getTieIconData() async {
    ...
    tieSnapShot.docs.forEach(
      (element) {
        tieIconData = CategoryIcon.fromDocument(element);
...
//get category data
  Future<void> getShirtData() async {
    ...
    shirtSnapShot.docs.forEach(
      (element) {
        shirtData = Product.fromDocument(element);
