...
bool obserText = true; //visibility
...
class _SignUpState extends State<SignUp> {
  ...
  void submit() async {
    ...
    try {
      ...
      result = await FirebaseAuth.instance.createUserWithEmailAndPassword(   //auth
    ...
    return Container(
      child: Column(
        ...
        children: <Widget>[
          ...
          PasswordTextFormField(   //widget
            obserText: obserText,  //visibility
            controller: password,
            name: "Password",
            onTap: () {
