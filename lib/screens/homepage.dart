...
//bool for select in drawer
  ...
  Widget _buildUserAccountsDrawerHeader() {
    ...
    List<UserModel> userModel = productProvider.userModelList; //get user data
      ...
      return GestureDetector(
        onTap: () {
          Navigator.of(context).push(
            MaterialPageRoute(
              builder: (ctx) => ListProduct( //product in category
                name: "Dress",
                snapShot: dress,
              ),
            ),
  ...
  Widget _buildFeature() {
    ...
    return Column(
      children: <Widget>[
          ...
          children: <Widget>[ //two products
            ...
            GestureDetector(
              onTap: () {
                Navigator.of(context).pushReplacement(
                  MaterialPageRoute(
                    builder: (ctx) => ListProduct( //product in xx
                      name: "Featured",
                      isCategory: false,
        ...
        Row(
          children: productProvider.getHomeFeatureList.map((e) { //list to product
            return Expanded(
              child: Row(
                children: <Widget>[
                  Expanded(
