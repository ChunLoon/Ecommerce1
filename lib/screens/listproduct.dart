...
class ListProduct extends StatelessWidget {
  ...
  Widget _buildSearchBar(context) { //search
    return isCategory == true
        ? IconButton(
            ...
            onPressed: () {
              ...
              showSearch(context: context, delegate: SearchCategory());//in category
            },
          )
        : IconButton(
            icon: Icon(
            ...
            onPressed: () {
              ...
              showSearch(context: context, delegate: SearchProduct());//in view more
            },
          );
  }
